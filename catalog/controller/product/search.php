...
class ControllerProductSearch extends Controller {
	public function index() {
		...
		if (isset($this->request->get['search'])) {
			...
			$data['heading_title3'] = sprintf($this->language->get('heading_title3'), $this->request->get['search']);
		} else {
		...
		$data['button_grid'] = $this->language->get('button_grid');
			...
			$data['text_emp'] = $this->language->get('text_emp');
			$data['text_call2'] = $this->language->get('text_call2');
		$data['text_recall'] = $this->language->get('text_recall');
		$data['text_name'] = $this->language->get('text_name');
		$data['text_email'] = $this->language->get('text_email');
		$data['text_message2'] = $this->language->get('text_message2');
		$data['button_research'] = $this->language->get('button_research');
		...
		if (isset($this->request->get['search']) || isset($this->request->get['tag'])) {
			...
			$data['text_total'] = sprintf($this->language->get('text_total'), count($results2));
