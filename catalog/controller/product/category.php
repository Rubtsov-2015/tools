	...
	public function index() {
		...
		if ($category_info) {
			...
			foreach ($results as $result) {
				...
				$category_info2 = $this->model_catalog_category->getCategory($result['category_id']);
				if ($category_info2['image']) {
					$image2 = $this->model_tool_image->resize($result['image'], 119,106);
				} else {
					$image2 = $this->model_tool_image->resize('placeholder.png', 119,106);
				}
				$data['categories'][] = array(
					'thumb' => $image2,
