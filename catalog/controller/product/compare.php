...
class ControllerProductCompare extends Controller {
	public function index() {
		...
		$data['text_comp1'] = $this->language->get('text_comp1');
		$data['text_comp2'] = $this->language->get('text_comp2');
		$data['text_comp3'] = $this->language->get('text_comp3');
		$data['text_comp4'] = $this->language->get('text_comp4');
		$data['text_comp5'] = $this->language->get('text_comp5');
		$data['text_comp6'] = $this->language->get('text_comp6');
		$data['text_comp7'] = $this->language->get('text_comp7');
