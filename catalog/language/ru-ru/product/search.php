<?php
// Heading
$_['heading_title']     = 'По запросу';
$_['heading_title2']     = 'Поиск';
$_['heading_title3']     = 'По запросу «%s» результатов не найдено';
$_['heading_tag']		= 'Тег - ';
...
$_['text_total']        = 'Найдено %s товаров';
$_['text_emp']        = 'Возможно, вы ввели некорректный запрос. Проверьте правильность написания.<br> Старайтесь использовать только ключевые слова.';
$_['text_call2']        = 'Свяжитесь с нами, и мы поможем найти товар';
$_['text_message2']        = 'Что вы ищете';
$_['button_research']        = 'Отправить заявку';
$_['result']        = 'Вы успешно отправили запрос!';
