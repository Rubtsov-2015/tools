...
$_['text_pagination2']       = 'Загрузить еще %s товаров';
$_['text_loading']          = 'Загрузка...';
$_['text_no_results']       = 'Нет результатов!';
$_['text_all']       = 'Посмотреть все';
$_['text_all2']       = 'Смотреть все';
$_['text_price']       = 'Цена';
$_['text_call']          = 'Звонок Вам';
$_['text_message']          = 'Написать';
$_['text_price']          = 'Цена';
$_['button_fastorder']          = 'Купить в 1 клик';
$_['text_tab1']          = 'Принадлежности';
$_['text_tab2']          = 'Описание';
$_['text_tab3']          = 'Характеристики';
$_['text_spec']          = 'Акция';
$_['text_top']          = 'Топ';
$_['text_recall']          = 'Обратная связь';
$_['text_name']          = 'Имя';
$_['text_email']          = 'Email';
$_['text_message2']          = 'Сообщение';
$_['button_call']          = 'Перезвоните';
$_['button_call2']          = 'Отправить';
$_['text_pr1']        = 'Параметры';
$_['text_pr2']        = 'Сортировка:';
$_['text_pr3']        = 'Вид:';
$_['text_pr4']        = 'Артикул';
$_['text_register']        = 'Или зарегистрироваться';
$_['result']        = 'Ваш запрос успешно отправлен!';
