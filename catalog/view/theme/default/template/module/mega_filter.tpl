									...
									<?php } else if( $filter['type'] == 'price' ) { ?>
										<div class="mfilter-option mfilter-price">
											...
											<div class="mfilter-price-slider">
												...
												<span class="range_price_val min"><?php echo (string) $price['min']; ?></span>
												<span class="range_price_val max"><?php echo (string) $price['max']; ?></span>
											</div>
										</div>
												...
												<div class="mfilter-option mfilter-tb-as-tr">
													<div class="mfilter-tb-as-td mfilter-col-input">
														<input 
															...
															<span></span>
															<label for="mfilter-opts-attribs-<?php echo (int) $_idx; ?>-<?php echo $base_id; ?>-<?php echo $option['key']; ?>"></label>
													</div>
