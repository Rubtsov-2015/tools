        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-links">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-related"><span data-toggle="tooltip" title="<?php echo $help_related; ?>"><?php echo $entry_related2; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="related2" value="" placeholder="<?php echo $entry_related2; ?>" id="input-related2" class="form-control" />
                  <div id="product-related2" class="well well-sm" style="height: 150px; overflow: auto;">
                    <?php foreach ($product_relateds2 as $product_related2) { ?>
                    <div id="product-related2<?php echo $product_related2['product_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $product_related2['name']; ?>
...
$('input[name=\'related2\']').autocomplete({
	...
	'select': function(item) {
		$('input[name=\'related2\']').val('');

		$('#product-related2' + item['value']).remove();

		$('#product-related2').append('<div id="product-related2' + item['value'] + '"><i class="fa fa-minus-circle"></i> ' + item['label'] + '<input type="hidden" name="product_related2[]" value="' + item['value'] + '" /></div>');
	}
});

$('#product-related2').delegate('.fa-minus-circle', 'click', function() {
	$(this).parent().remove();
});
//--></script>
  <script type="text/javascript"><!--
