...
class ModelCatalogProduct extends Model {
	public function addProduct($data) {
		...
		if (isset($data['product_related2'])) {
			foreach ($data['product_related2'] as $related_id2) {
				$this->db->query("DELETE FROM " . DB_PREFIX . "product_related2 WHERE product_id = '" . (int)$product_id . "' AND related_id = '" . (int)$related_id2 . "'");
				$this->db->query("INSERT INTO " . DB_PREFIX . "product_related2 SET product_id = '" . (int)$product_id . "', related_id = '" . (int)$related_id2 . "'");
				$this->db->query("DELETE FROM " . DB_PREFIX . "product_related2 WHERE product_id = '" . (int)$related_id2 . "' AND related_id = '" . (int)$product_id . "'");
				$this->db->query("INSERT INTO " . DB_PREFIX . "product_related2 SET product_id = '" . (int)$related_id2 . "', related_id = '" . (int)$product_id2 . "'");
			}
		}
	...
	public function editProduct($product_id, $data) {
		...
		if (isset($data['product_related2'])) {
			foreach ($data['product_related2'] as $related_id2) {
				...
				$this->db->query("INSERT INTO " . DB_PREFIX . "product_related2 SET product_id = '" . (int)$product_id . "', related_id = '" . (int)$related_id2 . "'");
				$this->db->query("DELETE FROM " . DB_PREFIX . "product_related2 WHERE product_id = '" . (int)$related_id2 . "' AND related_id = '" . (int)$product_id . "'");
				$this->db->query("INSERT INTO " . DB_PREFIX . "product_related2 SET product_id = '" . (int)$related_id2 . "', related_id = '" . (int)$product_id . "'");
			}
		}
	...
	public function copyProduct($product_id) {
		...
		if ($query->num_rows) {
			...
			$data['product_related2'] = $this->getProductRelated2($product_id);
	...
	public function getProductRelated2($product_id) {
		$product_related_data2 = array();

		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "product_related2 WHERE product_id = '" . (int)$product_id . "'");

		foreach ($query->rows as $result) {
			$product_related_data2[] = $result['related_id'];
		}

		return $product_related_data2;
	}
