...
class ControllerCatalogProduct extends Controller {
    ...
    if ($this->config->get('config_editor_default')) {
		...
		$data['entry_related2'] = $this->language->get('entry_related2');
    ...
    $data['manufacturers'] = $this->model_catalog_manufacturer->getManufacturers();
		...
		if (isset($this->request->post['product_related2'])) {
			$products2 = $this->request->post['product_related2'];
		} elseif (isset($this->request->get['product_id'])) {
			$products2 = $this->model_catalog_product->getProductRelated2($this->request->get['product_id']);
		} else {
			$products2 = array();
		}
